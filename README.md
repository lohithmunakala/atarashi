...
- Install the missing dependencies (`code_comment`, `textdistance`, `pyxDamerauLevenshtein`)
```sh
# python3 -m pip install textdistance>=3.0.3 pyxDamerauLevenshtein>=1.5 code_comment@git+https://github.com/amanjain97/code_comment@master#egg=code_comment
```
